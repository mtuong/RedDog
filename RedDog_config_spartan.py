...
'''
reference = "/data/projects/punim0092/reddog_testdata/shigella/NC_007384_with_plasmid.gbk"
sequences = "/data/projects/punim0092/reddog_testdata/shigella/*.fastq.gz"
output = "/data/projects/punim0092/reddog_testdata/mapping_test"
out_merge_target = ""
...
stageDefaults = {
    ...
    "modules": [
         ...
         "ea-utils/27a4809-GCC-4.9.2",
         "FastTree/2.1.7-intel-2016.u3",
